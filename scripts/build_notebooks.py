...
def nb07() -> None:
    ...
    c = [
        ...
        new_markdown_cell(
            ...
            "pretrained checkpoint, same data, same plans, two LR schedules. The number to quote for "
            "these checkpoints is the one over all 169 fold-0 validation cases - **0.789 plain vs "
            "0.803 warm-up** - not whatever two cases happened to give above.\n\n"
            "One subtlety worth carrying away: NB03's training curves for these *same two runs* nearly "
